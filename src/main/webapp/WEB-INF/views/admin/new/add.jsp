					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label for="lname">Tên tin tức</label> <input name="lname"
									type="text" class="form-control" placeholder="Nhập tên tin tức">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="area">Diện tích</label> <input name="area"
									type="text" class="form-control" placeholder="Nhập diện tích">
							</div>
							<div class="form-group">
								<label for="address">Địa chỉ</label> <input name="address"
									type="text" class="form-control" placeholder="Nhập địa chỉ">
							</div>
							<div class="form-group">
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<textarea class="form-control" id="detail" rows="7"
